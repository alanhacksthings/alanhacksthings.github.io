...
Understanding IP addresses and all-things-routing is essential for pentesting. Whether you’re traversing an Active Directory domain via a pivot machine (shoutout to [ligolo](https://github.com/nicocha30/ligolo-ng)) or simply having trouble getting a reverse shell due to some pesky firewall rule, a fastidious approach to routing is essential.
